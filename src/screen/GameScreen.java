...
/**
 * Game screen (co-op with shared team lives).
 */
public class GameScreen extends Screen {
	...
	public GameScreen(final GameState gameState,
		...
		// Bonus life adds to TEAM pool in shared-lives mode.
		if (this.bonusLife && state.isSharedLives()) {
			state.addTeamLife(1);
		}
	}
	...
	/** Return the SAME state reference (don’t create a new one). */
