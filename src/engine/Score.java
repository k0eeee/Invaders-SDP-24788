...
public class Score implements Comparable<Score> {
     ...
     * per-player breakdown
     */
    public final int getLevelReached()   { return this.levelReached; }
    public final int getLivesRemaining() { return this.livesRemaining; }

    // Per-player (null-safe for legacy scores)
    public final int getPlayerScore(int pid)  { return playerScores != null ? playerScores[pid] : 0; }
    public final int getPlayerBullets(int pid){ return playerBullets != null ? playerBullets[pid] : 0; }
    public final int getPlayerKills(int pid)  { return playerKills != null ? playerKills[pid] : 0; }
